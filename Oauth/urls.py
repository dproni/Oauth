...
#    url(r'^share/(?P<task_id>\d{1,4})/$', shareBoard, name='shareBoard'),
    url(r'^add/$', addTask, name='addTask'),
    url(r'^addBoard/$', addBoard, name='addBoard'),
    url(r'^deleteTask/(?P<task_id>[A-Za-z0-9]+)/$', deleteTask, name='deleteTask'),
    url(r'^deleteBoard/(?P<board_id>[A-Za-z0-9]+)/$', deleteBoard, name='deleteBoard'),
